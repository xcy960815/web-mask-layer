...
export default defineConfig({
  title: 'web-mask-layer',
  description: 'A simple, lightweight and customizable web mask layer.',
  base: '/web-mask-layer/',
  cleanUrls: true,
  ...
  locales: {
    root: {
      ...
      themeConfig: {
        nav: [
          ...
          {
            text: 'GitHub',
            link: 'https://github.com/xcy960815/web-mask-layer',
          },
        ],
        sidebar: [
          {
    ...
    'zh-CN': {
      label: '简体中文',
      lang: 'zh-CN',
      description: '一个简单、轻量级且可自定义的 Web 遮罩层。',
      themeConfig: {
        nav: [
